...
svm_rbf_pca_pipe = Pipeline([
    ('scaler', fixed_scaler),
    ('pca', PCA(n_components=0.95, svd_solver='auto', whiten=True)),
...
print(f"\nGemiddelde nested ROC-AUC: {svm_rbf_logreg_nested_scores['test_score'].mean():.4f}")
print(f"Standaarddeviatie nested ROC-AUC: {svm_rbf_logreg_nested_scores['test_score'].std():.4f}")
...
#%% ==================================================================================
# Final model SVM RBF + logreg
# ====================================================================================

# Final search op volledige trainingsset
svm_rbf_logreg_grid.fit(X_train, y_train)

# Beste parameters
print("\nFinal best params for SVM-RBF + logistic regression:")
print(svm_rbf_logreg_grid.best_params_)

# Beste CV-score op de volledige trainingsset
print(f"Final CV ROC-AUC on full training set: {svm_rbf_logreg_grid.best_score_:.4f}")

# Definitieve model
final_svm_rbf_logreg_model = svm_rbf_logreg_grid.best_estimator_
...
print(f"\nMean nested ROC-AUC: {np.mean(knn_logreg_nested_scores['test_score']):.4f}")
print(f"Std nested ROC-AUC: {np.std(knn_logreg_nested_scores['test_score']):.4f}")
...
#%% ==================================================================================
# Final model KNN + logreg
# ====================================================================================

# Final search op volledige trainingsset
knn_logreg_grid.fit(X_train, y_train)

# Beste parameters
print("\nFinal best params for KNN + logistic regression:")
print(knn_logreg_grid.best_params_)

# Beste CV-score op de volledige trainingsset
print(f"Final CV ROC-AUC on full training set: {knn_logreg_grid.best_score_:.4f}")

# Definitieve model
final_knn_logreg_model = knn_logreg_grid.best_estimator_
...
print(f"\nMean nested ROC-AUC: {np.mean(rf_logreg_nested_scores['test_score']):.4f}")
print(f"Std nested ROC-AUC: {np.std(rf_logreg_nested_scores['test_score']):.4f}")
...
#%% ==================================================================================
# Final model Random Forest + logreg
# ====================================================================================

# Final search op volledige trainingsset
rf_logreg_grid.fit(X_train, y_train)

# Beste parameters
print("\nFinal best params for Random Forest + logistic regression:")
print(rf_logreg_grid.best_params_)

# Beste CV-score op de volledige trainingsset
print(f"Final CV ROC-AUC on full training set: {rf_logreg_grid.best_score_:.4f}")

# Definitieve model
final_rf_logreg_model = rf_logreg_grid.best_estimator_
...
print(f"\nMean nested ROC-AUC: {np.mean(xgb_logreg_nested_scores['test_score']):.4f}")
print(f"Std nested ROC-AUC: {np.std(xgb_logreg_nested_scores['test_score']):.4f}")
...
#%% ==================================================================================
# Final model XGBoost + logreg
# ====================================================================================

# Final search op volledige trainingsset
xgb_logreg_grid.fit(X_train, y_train)

# Beste parameters
print("\nFinal best params for XGBoost + logistic regression:")
print(xgb_logreg_grid.best_params_)

# Beste CV-score op de volledige trainingsset
print(f"Final CV ROC-AUC on full training set: {xgb_logreg_grid.best_score_:.4f}")

# Definitieve model
final_xgb_logreg_model = xgb_logreg_grid.best_estimator_
